...
import logging
logger = logging.getLogger('ssl_crypto.__init__')

# Import 'ssl_crypto.formats' if a module tries to import the
# entire ssl_crypto package (i.e., from ssl_crypto import *). 
__all__ = ['formats']
